...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/tong/lsc_ws/src/ydlidar)
  set(ydlidar_DEVEL_PREFIX /home/tong/lsc_ws/devel)
  set(ydlidar_INSTALL_PREFIX "")
  set(ydlidar_PREFIX ${ydlidar_DEVEL_PREFIX})
else()
  set(ydlidar_SOURCE_PREFIX "")
  set(ydlidar_DEVEL_PREFIX "")
  set(ydlidar_INSTALL_PREFIX /home/tong/lsc_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'shao <shao@hahabot.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tong/lsc_ws/src/ydlidar/${idir}'.  ${_report}")
    endif()
