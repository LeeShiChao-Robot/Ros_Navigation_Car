...
echo_and_run cd "/home/tong/lsc_ws/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/tong/lsc_ws/src/rosserial/rosserial_vex_v5/setup.py" \
    build --build-base "/home/tong/lsc_ws/build/rosserial/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
